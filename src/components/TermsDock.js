      ...
      {openDock && (
        <div className="privacy-policy-overlay">
          ...
          >
            ...
            <h2>Terms and Conditions for $TENGE TENGE Memes</h2>
            <p>Last Modified: 20th Jan 2025</p>

            <h3>Website Ownership: </h3>
            <p>
              This website, located at www.TENGE TENGEmeme.com (the “Website”),
              is a community-owned platform managed entirely by the $TENGE TENGE
            ...
            <p>
              The Website serves as an access point for the $TENGE TENGE Memes,
              a Solana blockchain-based asset symbolizing support for the ideals
              represented by $TENGE TENGE. This coin is intended for community
            ...
            <h3>Transactions</h3>
            <p>
              All transactions involving $TENGE TENGE Memess are final and
              non-refundable. The value of these coins can be highly volatile.
            </p>

            <h3>Content and Proprietary Rights: </h3>
            <p>
              The community of $TENGE TENGE holders owns all content on the
              Website. You may not reproduce, redistribute, or create derivative
              works from any content without explicit community permission.
            </p>
            ...
            <p>
              The community of $TENGE TENGE Memes holders will not be liable for
            ...
            <p>
              ...
              <strong>support@TENGE TENGEmeme.com.</strong>
            </p>
          </div>
